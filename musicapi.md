# [NeteaseCloudMusicApi](https://neteasecloudmusicapi.js.org/#/?id=neteasecloudmusicapi)

网易云音乐 NodeJS 版 API

## [灵感来自](https://neteasecloudmusicapi.js.org/#/?id=灵感来自)
...
## [工作原理](https://neteasecloudmusicapi.js.org/#/?id=工作原理)

跨站请求伪造 (CSRF), 伪造请求头 , 调用官方 API

## [功能特性](https://neteasecloudmusicapi.js.org/#/?id=功能特性)
...
## [运行](https://neteasecloudmusicapi.js.org/#/?id=运行)
...
## [可以使用代理](https://neteasecloudmusicapi.js.org/#/?id=可以使用代理)
...
## [更新到 v3.0 说明](https://neteasecloudmusicapi.js.org/#/?id=更新到-v30-说明)
...
## [Docker 容器运行](https://neteasecloudmusicapi.js.org/#/?id=docker-容器运行)
...
## [接口文档](https://neteasecloudmusicapi.js.org/#/?id=接口文档)

### [调用前须知](https://neteasecloudmusicapi.js.org/#/?id=调用前须知)
...
由于网易限制,此项目在国外服务器上使用会受到限制,如需解决 , 可使用大陆服务器或者使用代理 , 感谢 [@hiyangguo](https://github.com/hiyangguo)提出的[解决方法](https://github.com/Binaryify/NeteaseCloudMusicApi/issues/29#issuecomment-298358438): 在 '/util/request.js' 的 'headers' 处增加 `X-Real-IP':'211.161.244.70' // 任意国内 IP` 即可解决
...
### [登录](https://neteasecloudmusicapi.js.org/#/?id=登录)

说明 : 登录有两个接口

#### [1. 手机登录](https://neteasecloudmusicapi.js.org/#/?id=_1-手机登录)
...
#### [2. 邮箱登录](https://neteasecloudmusicapi.js.org/#/?id=_2-邮箱登录)
...
返回数据如下图 : ![登录](https://raw.githubusercontent.com/Binaryify/NeteaseCloudMusicApi/master/static/%E7%99%BB%E5%BD%95.png)

完成登录后 , 会在浏览器保存一个 Cookies 用作登录凭证 , 大部分 API 都需要用到这个 Cookies

#### [注意](https://neteasecloudmusicapi.js.org/#/?id=注意)

调用登录接口的速度比调用其他接口慢 , 因为登录过程调用了加密算法

### [刷新登录](https://neteasecloudmusicapi.js.org/#/?id=刷新登录)

说明 : 调用此接口 , 可刷新登录状态

**调用例子 :** `/login/refresh`

### [发送验证码](https://neteasecloudmusicapi.js.org/#/?id=发送验证码)
...
### [验证验证码](https://neteasecloudmusicapi.js.org/#/?id=验证验证码)
...
### [注册(修改密码)](https://neteasecloudmusicapi.js.org/#/?id=注册修改密码)
...
### [检测手机号码是否已注册](https://neteasecloudmusicapi.js.org/#/?id=检测手机号码是否已注册)
...
### [初始化昵称](https://neteasecloudmusicapi.js.org/#/?id=初始化昵称)
...
### [更换绑定手机](https://neteasecloudmusicapi.js.org/#/?id=更换绑定手机)
...
### [退出登录](https://neteasecloudmusicapi.js.org/#/?id=退出登录)

说明 : 调用此接口 , 可退出登录

**调用例子 :** `/logout`

### [登录状态](https://neteasecloudmusicapi.js.org/#/?id=登录状态)

说明 : 调用此接口,可获取登录状态

**接口地址 :** `/login/status` 返回数据如下图: ![数据](https://ws2.sinaimg.cn/large/006tNbRwgy1fup6q18kk6j316i0nw0wa.jpg)

### [获取用户详情](https://neteasecloudmusicapi.js.org/#/?id=获取用户详情)
...
### [获取用户信息 , 歌单，收藏，mv, dj 数量](https://neteasecloudmusicapi.js.org/#/?id=获取用户信息-歌单，收藏，mv-dj-数量)
...
### [更新用户信息](https://neteasecloudmusicapi.js.org/#/?id=更新用户信息)
...
### [获取用户歌单](https://neteasecloudmusicapi.js.org/#/?id=获取用户歌单)
...
### [更新歌单](https://neteasecloudmusicapi.js.org/#/?id=更新歌单)

说明 : 登陆后调用此接口,可以更新用户歌单 参数:
...
### [更新歌单描述](https://neteasecloudmusicapi.js.org/#/?id=更新歌单描述)

说明 : 登陆后调用此接口,可以单独更新用户歌单描述 参数:
...
### [更新歌单名](https://neteasecloudmusicapi.js.org/#/?id=更新歌单名)

说明 : 登陆后调用此接口,可以单独更新用户歌单名 参数:
...
### [更新歌单标签](https://neteasecloudmusicapi.js.org/#/?id=更新歌单标签)

说明 : 登陆后调用此接口,可以单独更新用户歌单标签 参数:
...
### [获取用户电台](https://neteasecloudmusicapi.js.org/#/?id=获取用户电台)
...
### [获取用户关注列表](https://neteasecloudmusicapi.js.org/#/?id=获取用户关注列表)
...
### [获取用户粉丝列表](https://neteasecloudmusicapi.js.org/#/?id=获取用户粉丝列表)
...
### [获取用户动态](https://neteasecloudmusicapi.js.org/#/?id=获取用户动态)
...
### [转发用户动态](https://neteasecloudmusicapi.js.org/#/?id=转发用户动态)
...
如下图 ![img](https://ws4.sinaimg.cn/large/006tNc79gy1g2trwz8o2gj31b20r6t9n.jpg) ![img](https://ws3.sinaimg.cn/large/006tNc79gy1g2trxa0vlej319u0gyjrq.jpg)

### [删除用户动态](https://neteasecloudmusicapi.js.org/#/?id=删除用户动态)
...
### [分享歌曲、歌单、mv、电台、电台节目到动态](https://neteasecloudmusicapi.js.org/#/?id=分享歌曲、歌单、mv、电台、电台节目到动态)
...
### [获取动态评论](https://neteasecloudmusicapi.js.org/#/?id=获取动态评论)
...
### [关注/取消关注用户](https://neteasecloudmusicapi.js.org/#/?id=关注取消关注用户)
...
### [获取用户播放记录](https://neteasecloudmusicapi.js.org/#/?id=获取用户播放记录)
...
### [获取热门话题](https://neteasecloudmusicapi.js.org/#/?id=获取热门话题)
...
### [云村热评](https://neteasecloudmusicapi.js.org/#/?id=云村热评)
...
### [心动模式/智能播放](https://neteasecloudmusicapi.js.org/#/?id=心动模式智能播放)
...
### [获取动态消息](https://neteasecloudmusicapi.js.org/#/?id=获取动态消息)
...
### [歌手分类列表](https://neteasecloudmusicapi.js.org/#/?id=歌手分类列表)
...
返回数据如下图: ![数据](https://ws1.sinaimg.cn/large/006tKfTcgy1fr60g9zps9j31kw1bpk4n.jpg)

### [收藏/取消收藏歌手](https://neteasecloudmusicapi.js.org/#/?id=收藏取消收藏歌手)
...
### [歌手热门50首歌曲](https://neteasecloudmusicapi.js.org/#/?id=歌手热门50首歌曲)
...
### [收藏的歌手列表](https://neteasecloudmusicapi.js.org/#/?id=收藏的歌手列表)
...
### [收藏视频](https://neteasecloudmusicapi.js.org/#/?id=收藏视频)
...
### [收藏/取消收藏 MV](https://neteasecloudmusicapi.js.org/#/?id=收藏取消收藏-mv)
...
### [收藏的 MV 列表](https://neteasecloudmusicapi.js.org/#/?id=收藏的-mv-列表)
...
### [歌单分类](https://neteasecloudmusicapi.js.org/#/?id=歌单分类)
...
### [热门歌单分类](https://neteasecloudmusicapi.js.org/#/?id=热门歌单分类)
...
### [歌单 ( 网友精选碟 )](https://neteasecloudmusicapi.js.org/#/?id=歌单-网友精选碟-)
...
### [获取精品歌单](https://neteasecloudmusicapi.js.org/#/?id=获取精品歌单)
...
### [相关歌单推荐](https://neteasecloudmusicapi.js.org/#/?id=相关歌单推荐)
...
### [获取歌单详情](https://neteasecloudmusicapi.js.org/#/?id=获取歌单详情)
...
### [获取音乐 url](https://neteasecloudmusicapi.js.org/#/?id=获取音乐-url)
...
### [音乐是否可用](https://neteasecloudmusicapi.js.org/#/?id=音乐是否可用)
...
### [搜索](https://neteasecloudmusicapi.js.org/#/?id=搜索)
...
### [默认搜索关键词](https://neteasecloudmusicapi.js.org/#/?id=默认搜索关键词)

说明 : 调用此接口 , 可获取默认搜索关键词

**接口地址 :** `/search/default`

### [热搜列表(简略)](https://neteasecloudmusicapi.js.org/#/?id=热搜列表简略)
...
### [热搜列表(详细)](https://neteasecloudmusicapi.js.org/#/?id=热搜列表详细)
...
### [搜索建议](https://neteasecloudmusicapi.js.org/#/?id=搜索建议)
...
### [搜索多重匹配](https://neteasecloudmusicapi.js.org/#/?id=搜索多重匹配)
...
### [新建歌单](https://neteasecloudmusicapi.js.org/#/?id=新建歌单)
...
返回数据如下图: ![数据](https://ws1.sinaimg.cn/large/006tKfTcgy1fr3va885z5j31a617qwjy.jpg)

### [删除歌单](https://neteasecloudmusicapi.js.org/#/?id=删除歌单)
...
### [收藏/取消收藏歌单](https://neteasecloudmusicapi.js.org/#/?id=收藏取消收藏歌单)
...
返回数据如下图: ![数据](https://ws1.sinaimg.cn/large/006tKfTcgy1fr3vdwx0hvj30s405u74b.jpg)

### [歌单收藏者](https://neteasecloudmusicapi.js.org/#/?id=歌单收藏者)
...
### [对歌单添加或删除歌曲](https://neteasecloudmusicapi.js.org/#/?id=对歌单添加或删除歌曲)
...
### [获取歌词](https://neteasecloudmusicapi.js.org/#/?id=获取歌词)
...
### [新歌速递](https://neteasecloudmusicapi.js.org/#/?id=新歌速递)
...
### [歌曲评论](https://neteasecloudmusicapi.js.org/#/?id=歌曲评论)
...
### [专辑评论](https://neteasecloudmusicapi.js.org/#/?id=专辑评论)
...
### [歌单评论](https://neteasecloudmusicapi.js.org/#/?id=歌单评论)
...
### [mv 评论](https://neteasecloudmusicapi.js.org/#/?id=mv-评论)
...
### [电台节目评论](https://neteasecloudmusicapi.js.org/#/?id=电台节目评论)
...
### [视频评论](https://neteasecloudmusicapi.js.org/#/?id=视频评论)
...
### [热门评论](https://neteasecloudmusicapi.js.org/#/?id=热门评论)
...
### [给评论点赞](https://neteasecloudmusicapi.js.org/#/?id=给评论点赞)
...
### [发送/删除评论](https://neteasecloudmusicapi.js.org/#/?id=发送删除评论)
...
**调用例子** : `/comment?t=0&type=1&id=5436712&commentId=1535550516319` (在广岛之恋 mv 删除评论)
 ...
 注意：如给动态删除评论，则不需要传 id，需要传动态的 `threadId`,如：`/comment?t=0&type=6&threadId=A_EV_2_6559519868_32953014&com
```
